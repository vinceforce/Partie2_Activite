...
Celle-ci consiste à faire 4 commits sur un repository spécifique
J'ai choisi d'ajouter au repository le code du jeu de plateau développé dans le cadre du parcours "Disciple du javascript"

REGLES DU JEU
Les joueurs jouent à tour de rôle
A chaque tour, on peut se déplacer de 1 à 3 cases
Si on se trouve sur une case contigüe à celle d'un autre joueur, un combat démarre
